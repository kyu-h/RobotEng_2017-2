...
volatile int r_speed=130; //right speed
volatile int l_speed=240;  //left speed
...
// put your setup code here, to run once:
  ...
  Serial.begin(9600);
  Motor_Control(FORW,r_speed,BACK,l_speed);
}
...
void loop() {
  ...
  if(1){
    ...
    r_speed_reality=r_val/(time_step/1000);
     Serial.print("r_cnt:");
     Serial.print(r_val);
     Serial.print("\t r_speed_real(cnts/sec):");
     Serial.print(r_speed_reality);
     //  calculate speed
     l_speed_reality=l_val/(time_step/1000);
     Serial.print("\t l_cnt:");
     Serial.print(l_val);
     Serial.print("\t l_speed_real(cnts/sec):");
